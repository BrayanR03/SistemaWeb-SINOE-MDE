$(document).ready(function() {
    ...
    let pagina = 1;
    let descripcionFiltro = $('#Descripcion').val();


    generarOpcionesPaginacion()

    function loadAreas(descripcionFiltro,pagina, registrosPorPagina) {
        $.ajax({
            url: './controllers/areas/listarAreas.php',
            method: 'GET',
            dataType: 'json',
            data: {descripcionFiltro,pagina, registrosPorPagina},
    ...
    loadAreas(descripcionFiltro,pagina, registrosPorPagina);
