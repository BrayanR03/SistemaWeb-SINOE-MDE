<div id="modalRegistrarSede" class="modalArea modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form class="formArea" id="registrarSedeForm" action="" method="post">
                <div class="modal-body">
                    <div class="mb-3">
                        <label for="descripcionSede" class="form-label">Descripción (*):</label>
                        <input type="text" id="descripcionSedeNuevo" autocomplete="off">
                    </div>
