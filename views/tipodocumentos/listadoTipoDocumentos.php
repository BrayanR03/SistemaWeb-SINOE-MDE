...
<div class="containerListadoArea">
    <div class="listadoAreas_header">
        <div>
            <h3 style="font-weight: bold;">GESTIÓN DE TIPO DE DOCUMENTOS</h3>
            <p style="color: #006B2D;">LISTADO DE TIPOS DE DOCUMENTOS</p>
        ...
        <a href="" style="background-color: #006B2D;" id="btnRegistrarTipoDocumento" class="btnNuevoRegistro">
            ...
            Registrar Nuevo Tipo Documento
        </a>
    </div>
    <div class="text-end">
        <p class="fs-6">Total de registros: <span class="fw-bold" id="totalTDRegistrados"></span></p>
        <div>
    ...
    <div class="listadoAreas_body container-table" style="margin-top: 15px;">
        <table>
            ...
            <tbody id="bodyListaTipoDocumentos">
...
<?php  require_once "registrarTipoDocumento.php"?>
<?php  require_once "editarTipoDocumento.php"?>

<script src="<?= base_url ?>ajax/tipodocumentos.js"></script>