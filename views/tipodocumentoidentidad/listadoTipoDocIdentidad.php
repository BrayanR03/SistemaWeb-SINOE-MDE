...
<div class="containerListadoArea">
    <div class="listadoAreas_header">
        <div>
            <h3 style="font-weight: bold;">GESTIÓN DE TIPO DOCUMENTOS DE IDENTIDAD</h3>
            <p style="color: #006B2D;">LISTADO DE TIPOS DOCUMENTOS DE IDENTIDAD</p>
            <div class="containerFiltrado">
                <div class="busqueda">
                    ...
                    <input
                        ...
                        value=""
                        autocomplete="off"
                        placeholder="Descripcion del Tipo Documento de Identidad">
                </div>
            </div>
        </div>
        <a href="" style="background-color: #006B2D;" id="btnRegistrarTipoDocumentoIdentidad" class="btnNuevoRegistro">
            ...
            Registrar Nuevo Tipo Documento de Identidad
        </a>
    </div>
    <div class="text-end">
        <p class="fs-6">Total de registros: <span class="fw-bold" id="totalTDIRegistrados"></span></p>
        <div>
    ...
    <div class="listadoAreas_body container-table" style="margin-top: 15px;">
        <table>
            ...
            <tbody id="bodyListaTipoDocumentosIdentidad">
...
<?php  require_once "registrarTipoDocIdentidad.php"?>
<?php  require_once "editarTipoDocIdentidad.php"?>
