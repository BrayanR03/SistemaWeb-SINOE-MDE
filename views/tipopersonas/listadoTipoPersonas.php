...
<div class="containerListadoArea">
    <div class="listadoAreas_header">
        <div>
            <h3 style="font-weight: bold;">GESTIÓN DE TIPO DE PERSONAS</h3>
            <p style="color: #006B2D;">LISTADO DE TIPOS DE PERSONAS</p>
            <div class="containerFiltrado">
                <div class="busqueda">
                    ...
                    <input
                        ...
                        value=""
                        autocomplete="off"
                        placeholder="Descripcion del Tipo de Persona">
                </div>
            </div>
        </div>
        <a href="" style="background-color: #006B2D;" id="btnRegistrarTipoPersona" class="btnNuevoRegistro">
            ...
            Registrar Nuevo Tipo Persona
        </a>
    </div>
    <div class="text-end">
        <p class="fs-6">Total de registros: <span class="fw-bold" id="totalTPRegistrados"></span></p>
        <div>
    ...
    <div class="listadoAreas_body container-table" style="margin-top: 15px;">
        <table>
            ...
            <tbody id="bodyListaTipoPersonas">
...
<?php  require_once "registrarTipoPersonas.php"?>
<?php  require_once "editarTipoPersonas.php"?>
