...
<div class="containerListadoArea">
    <div class="listadoAreas_header">
        <div>
            <h3 style="font-weight: bold;">GESTIÓN DE TIPO DE CASILLAS</h3>
            <p style="color: #006B2D;">LISTADO DE TIPOS DE CASILLAS</p>
            <div class="containerFiltrado">
                <div class="busqueda">
                    ...
                    <input
                        ...
                        value=""
                        autocomplete="off"
                        placeholder="Descripcion del Tipo de Casilla">
                </div>
            </div>
        </div>
        <a href="" style="background-color: #006B2D;" id="btnRegistrarTipoCasilla" class="btnNuevoRegistro">
            ...
            Registrar Nuevo Tipo Casilla
        </a>
    </div>
    <div class="text-end">
        <p class="fs-6">Total de registros: <span class="fw-bold" id="totalTCRegistrados"></span></p>
        <div>
    ...
    <div class="listadoAreas_body container-table" style="margin-top: 15px;">
        <table>
            ...
            <tbody id="bodyListaTipoCasillas">
...
<?php  require_once "registrarTipoCasilla.php"?>
<?php  require_once "editarTipoCasilla.php"?>
